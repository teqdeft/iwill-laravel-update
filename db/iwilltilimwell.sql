...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2021 at 02:38 PM
...
CREATE TABLE `users` (
  ...
  `groupCode` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `timezoneId` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `disableNotifications` tinyint(4) DEFAULT NULL,
  `sendRegistrationNotification` tinyint(4) DEFAULT NULL,
  `numAllowedDependents` int(11) DEFAULT NULL,
  `language` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customAttributeId` int(11) DEFAULT NULL,
  `customAttributeValue` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `effectiveDate` date DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `user_role` enum('super_admin','admin','user') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
