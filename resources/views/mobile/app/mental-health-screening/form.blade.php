<div class="midical-form v1 detail" id="consent">
    ...
    <form class="sfty-pln-v1" action="{{ route('updateStep') }}">
        <div class="form-row">
		
            <div class="col-100 form-group">
                <div class="custom-radio-group indicate-radio">
				
                    <label class="custom-radio">I authorize iWILL ’til i’mWELL to release, disclose, and/or exchange my Medical and Mental Health Records.<input type="radio" name="visitor_permission" value="1" checked onclick="getVPermission()"><span class="custom-radio-button"></span></label>
                    ...
                    <label class="custom-radio">I do not authorize iWILL ’til i’mWELL to release, disclose, and/or exchange my Medical and Mental Health Records. <input type="radio" name="visitor_permission" value="2" onclick="getVPermission()"><span class="custom-radio-button"></span></label>
                                        ...
                                        <div class="col-100 form-group">
                                            <div class="inner-title mb-0">
                                                <p>This consent will expire one year after the date signed.</p>
                                            </div>
                                        </div>
                                        <div class="col-50 form-group">
                                            <label>Name <span class="required-ico">*</span></label>
                                            <input class="form-control" placeholder="" type="text" name="name_of_school" id="name_of_school" value="{{ Auth::user()->fname }} {{ Auth::user()->lname }}">
                                        </div>
                                        <div class="col-50 form-group" style="display:none;">
                                            <label>Signature</label> 
                                            <input class="form-control" placeholder="Full Name" type="text" name="student_id" id="student_id" value="{{ Auth::user()->fname }} {{ Auth::user()->lname }}">
                                        </div>
                                        <div class="col-50 form-group" style="display:none;">
                                        ...
                                        <div class="col-50 form-group">
                                            ...
                                            <input class="form-control" placeholder="" type="text" name="created_dated" id="created_dated" value="<?php echo date('Y-m-d')?>" disabled>
                                        </div>
