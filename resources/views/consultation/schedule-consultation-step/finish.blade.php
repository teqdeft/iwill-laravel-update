...
<div id="finish-tab" class="tab-content">
	...
	<div class="care-consultation-thanku">
        ...
        <div class="text">
            <p>A confirmation text message has been sent to <a href="tel:{{ $user->primaryPhone }}"><b>{{ $user->primaryPhone }}</b></a>. All other notifications related to this appointment will also be sent to <a href="tel:{{ $user->primaryPhone }}"><b>{{ $user->primaryPhone }}</b></a>.</p>
        ...
        <div class="consul-card">
            <p>The provider or a member of our staff may also contact you from <a
                    href="tel:866-223-8831"><b>866-223-8831</b></a>. We suggest adding this number to your contacts to
                prevent any missed calls.</p>
        </div>
        ...
        <div class="cta">
            <a href="{{url('dashboard')}}" class="medicine-detail-btn">Return to Dashboard</a>
        </div>
